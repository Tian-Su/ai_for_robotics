    ...
    def plan_delivery(self):
        ...
        if self.testcase == 1:
            moves = ['move 1.570963 2.0',  # rotate and move north 2 spaces
                     'move 1.570963 0.1',
                     # rotate west and move closer to second box
                     'lift 1',  # lift the second box
                     'move 0.785398 1.5',
                     # rotate to sw and move down 1.5 squares
                     'down 3.5 -4.0',  # set the box out of the way
                     'move -0.785398 2.0',
                     # rotate to west and move 2.5 squares
                     'move -1.570963 2.7',
                     # rotate to north and move to pick up box 0
                     ...
                     'move -1.570963 0.6',
                     # rotate to west and move towards box 1
                     'lift 1',  # lift the second box
                     'move 1.570963 0.0',  # rotate north
                     'move 1.570963 0.6',
                     # rotate east and move back towards dropzone
        ...
        if self.testcase == 3:
            moves = ['move 0.0 1.0',
                     # ***Try moving directly east - should crash into warehouse east wall  cost = 100
                     'move -1.570963 0.0',  # cost += 1 = 101
                     'move -1.570963 3.0']  # ***Rotated back west - crash into obstacle  cost += 100*3 = 401

        if self.testcase == 4:
            moves = ['move -1.570963 .0',
                     # a total of -135 degrees to the SE   cost = 1.0
                     'move -0.785398 1.414',  # cost += 2.414  = 3.414
                     'move -0.785398 3.0',
                     # move towards west                   cost += 4 = 7.414
                     'move 1.570963 3.0',
                     # rotate and move south               cost += 4 = 11.414
                     'move 1.570963 2.0',
                     # rotate and move east                cost += 3 = 14.414
                     'move 1.570963 0.9',
                     # *** rotate north, move too close to box 0             cost += 100*0.9 = 104.414
                     'move 1.570963 0.0',
                     # rotate west                         cost += 1 = 105.414
                     'move 1.570963 .5',
                     # rotate south and move away from box cost += 1.5 = 106.914
                     'lift 0',
                     # *** try to lift a box, too far away cost += 2 = 108.914
                     'move -1.570963 0.0',
                     # rotate west                         cost += 1 = 109.914
                     'move -1.570963 0.4',
                     # rotate north and move closer        cost += 1.4 = 111.314
                     'lift 0',
                     # legally lift box                    cost += 2 = 113.314
                     'down 2.5 -4.',
                     # *** try to set box down too far away                  cost += 1.5 = 114.814
                     'move 1.570963 0.',
                     # rotate west                         cost += 1 = 115.814
                     'move 1.570963 0.55',
                     # rotate south and move south         cost += 1.55 = 117.364
                     'move -1.570963 3.0',
                     # rotate west and move west           cost += 4.0 = 121.364
                     'move -1.570963 3.1',
                     # rotate north and move north         cost += 4.1 = 125.464
